...
export class PhotoEditorComponent implements OnInit {
  ...
  initializeUploader() {
    this.uploader = new FileUploader({
      ...
      autoUpload: false,
      maxFileSize: 10 * 1024 * 1024 // 10 MBs
    });

    this.uploader.onAfterAddingFile = (file) => {
      file.withCredentials = false; // Instead of modifying the CORS configurations in our API, we use the bearer token here in authToken
    }
